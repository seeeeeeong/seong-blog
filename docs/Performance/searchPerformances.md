...
> http://dev.officialhey.com/performances/search

### Parameters
#### Request
|   name   |        type         |             description             | required |
|:--------:|:-------------------:|:-----------------------------------:| :---: |
| keyword  |       String        |                 키워드                 | **Required** |
| statuses | PerformanceStatus[] | 공연 상태(UPCOMING, ONGOING, COMPLETED) | **Required** |
